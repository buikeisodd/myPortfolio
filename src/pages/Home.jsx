...
import {
  ArrowRight, ArrowUpRight, Code2, Layers, Zap,
  Star, Coffee, Briefcase, Users,
} from "lucide-react";
...
const codeLines = [
  { indent: 0, text: "const buike = {",       color: "#fafafa" },
  { indent: 1, text: 'role: "FE Dev",',        color: "#a3e635" },
...
export default function Home() {
  ...
  return (
    <div className="relative">
      ...
      {/* ════════ HERO ════════
          FIX: Removed useScroll + useTransform parallax on the hero wrapper.
          On Android the scroll progress miscalculates due to dynamic URL bar
          height, setting heroOpacity to 0 and making all hero content invisible.
          The hero now renders with full opacity always — clean and reliable. */}
      <section className="relative min-h-screen flex items-center overflow-hidden pt-20">

        {/* Ambient glow blobs */}
        <motion.div
          className="glow-blob w-[500px] h-[500px] -top-40 -left-60 bg-lime-400/[0.06]"
          animate={{ scale: [1, 1.1, 1], x: [0, 20, 0] }}
          transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="glow-blob w-[400px] h-[400px] top-40 -right-60 bg-violet-500/[0.07]"
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[calc(100vh-80px)]">
            ...
            <div className="flex flex-col justify-center pt-16 pb-24 lg:py-0">
              ...
              <motion.h1
                ...
                className="font-display text-[clamp(3.5rem,12vw,8rem)] leading-none text-white mb-4 tracking-wide"
              >
                CHIBUIKE
                <br />
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 px-5 py-4 border-b border-[#1e1e1e] bg-[#111]">
                  ...
                  <div className="ml-4 font-mono-custom text-[10px] text-zinc-600 tracking-wider">developer.js</div>
                </div>
                <div className="p-5 font-mono-custom text-sm leading-loose">
                  {codeLines.map((line, i) => (
                    <motion.div key={i} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }}
                      transition={{ delay: 1 + i * 0.08, duration: 0.4 }}
                      className="flex" style={{ paddingLeft: `${line.indent * 16}px` }}>
                      <span className="text-[13px]" style={{ color: line.color }}>{line.text}</span>
                    </motion.div>
                  ))}
                  <motion.span
        ...
        >
          <span className="font-mono-custom text-[10px] tracking-widest text-zinc-700 uppercase">scroll</span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <FadeIn><p className="section-label mb-6">About Me</p></FadeIn>
              <FadeIn delay={0.1}>
                <h2 className="font-display text-[clamp(2.5rem,6vw,4.5rem)] leading-none tracking-wide text-white mb-6">
                  BUILDING WITH<br /><span className="text-lime-400">PURPOSE</span>
                </h2>
              </FadeIn>
              <FadeIn delay={0.2}>
                <p className="text-zinc-500 leading-relaxed mb-5">
                  I'm a front-end developer with 5+ years of experience turning ambitious ideas
                  into polished digital products. I obsess over performance, accessibility, and
                  the small interactions that make interfaces feel alive.
                </p>
              </FadeIn>
              <FadeIn delay={0.3}>
                <p className="text-zinc-500 leading-relaxed mb-8">
                  When I'm not shipping features, I'm open-sourcing tools, writing about frontend
                  architecture, or exploring the intersection of design systems and developer experience.
                </p>
              </FadeIn>
              <FadeIn delay={0.4}>
                <div className="flex flex-wrap gap-4">
                  {[
                    ...
                    <div key={label} className="flex items-center gap-3 px-5 py-3 rounded-xl bg-[#111] border border-[#1e1e1e]">
            ...
            <div>
              <FadeIn delay={0.15}><p className="section-label mb-6">Tech Stack</p></FadeIn>
      ...
      <section className="py-28 bg-[#080808]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-14">
            <div>
              <FadeIn><p className="section-label mb-4">Selected Work</p></FadeIn>
              <FadeIn delay={0.1}>
                <h2 className="font-display text-[clamp(2.5rem,6vw,4.5rem)] leading-none tracking-wide text-white">
                  FEATURED<br /><span className="text-lime-400">PROJECTS</span>
                </h2>
              </FadeIn>
            </div>
            <FadeIn delay={0.2}>
                  ...
                  <div className={`relative h-48 bg-gradient-to-br ${project.gradient} overflow-hidden`}>
                    ...
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-3">
                      <a href={project.githubUrl} target="_blank" rel="noopener noreferrer"
                        className="px-4 py-2 border border-white/30 rounded-full text-white/80 text-xs backdrop-blur-sm hover:bg-white/10 transition-colors">GitHub</a>
                      <a href={project.liveUrl} target="_blank" rel="noopener noreferrer"
                        className="px-4 py-2 bg-lime-400 rounded-full text-zinc-950 text-xs font-semibold hover:bg-lime-300 transition-colors">Live Demo</a>
                    </div>
                  </div>
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <FadeIn className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <h2 className="font-display text-[clamp(3rem,8vw,6rem)] leading-none tracking-wide text-white mb-6">
            HAVE AN IDEA?<br /><span className="text-lime-400">LET'S BUILD IT.</span>
          </h2>
          <p className="text-zinc-500 mb-10 max-w-md mx-auto leading-relaxed">
            Whether you need a new product built from scratch or want to level up your existing platform — I'm here for it.
          </p>
          <Link to="/contact">
